<template>
  <div class="punch">
    <div class="punch-operate">
      ...
      <div
        :class="['time-btn-wrap',isWeekDays?'':'disabled',confirmStatus==='CONFIRMED'?'disabled':'']"
      >
        <div
      ...
      this.$getData
        ...
        .then(res => {
          if (res.code == 200) {
            ...
            const { checkinDateId, confirmStatus } = checkinRecordRespList[0];
            this.checkinDateId = checkinDateId;
            this.confirmStatus = confirmStatus;
            if (type === "add") {
